...
class RestApi(object):
    ...
    def __init__(self, domain='gw.api.taobao.com', port = 80):
        ...
        if(user_auth.vendors.top.getDefaultAppInfo()):
            self.__app_key = user_auth.vendors.top.getDefaultAppInfo().appkey
            self.__secret = user_auth.vendors.top.getDefaultAppInfo().secret
